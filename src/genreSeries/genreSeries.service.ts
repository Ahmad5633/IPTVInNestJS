...
export class GenreSeriesService {
  constructor(
    ...
    private readonly genreSeriesModel: Model<GenreSeriesDocument>,
  ) {}
  ...
  async updateGenreSeries(
    id: string,
    updateGenreSeriesDto: Partial<GenreSeries>,
  ): Promise<GenreSeries> {
    return this.genreSeriesModel
      .findByIdAndUpdate(id, updateGenreSeriesDto, { new: true })
      .exec();
  }
